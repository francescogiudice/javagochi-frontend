...
export const getJcRaces = () => {
    return dispatch => {
        ...
        axios.get('https://54.226.199.227:8000/api/javagochi/market/')
        .then(res => {
...
export const getJcRace = (race) => {
    return dispatch => {
        ...
        axios.get(`https://54.226.199.227:8000/api/javagochi/${race}`)
        .then((res) => {
...
export const buyJavagochi = (race, user, nickname) => {
    return dispatch => {
        ...
        axios.post("https://54.226.199.227:8000/api/javagochi/buy/", {
          user: user,
          race: race,
          nickname: nickname
        })
