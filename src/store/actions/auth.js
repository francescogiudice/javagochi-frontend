...
export const authLogin = (username, password) => {
    return dispatch => {
        dispatch(authStart());
        axios.post("https://54.226.199.227:8000/rest-auth/login/", {
            username: username,
            password: password
        })
        .then(res => {
...
export const authSignup = (username, email, password1, password2) => {
    return dispatch => {
        dispatch(authStart());
        axios.post("https://54.226.199.227:8000/rest-auth/registration/", {
            username: username,
            email: email,
            password1: password1,
            password2: password2
...
export const authChangeProfile = (old_username, new_username, new_email, new_password) => {
    return dispatch => {
        ...
        dispatch(authStart());
        axios.patch(`https://54.226.199.227:8000/api/users/${old_username}/change/`, {
...
export const getLevel = (lvl) => {
    return dispatch => {
        ...
        axios.get(`https://54.226.199.227:8000/api/users/expmap/${lvl}/`)
        .then(res => {
...
export const getUser = (username) => {
    return dispatch => {
        ...
        axios.get(`https://54.226.199.227:8000/api/users/${username}/info/`)
        .then(res => {
            const user = res.data;
...
export const getUsers = (user) => {
    return dispatch => {
        ...
        axios.get(`https://54.226.199.227:8000/api/users/${user}/all`)
        .then(res => {
