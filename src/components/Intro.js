...
const Intro = () => {
    ...
    return (
        <div>
            <Carousel autoplay>
                <div><img alt="first_carusel_image" src="https://54.226.199.227:8000/media/intro/first_carusel_image.jpg" /></div>
                <div><img alt="second_carusel_image" src="https://54.226.199.227:8000/media/intro/second_carusel_image.jpg" /></div>
                <div><img alt="second_carusel_image" src="https://54.226.199.227:8000/media/intro/third_carusel_image.jpg" /></div>
                <div><img alt="second_carusel_image" src="https://54.226.199.227:8000/media/intro/fourth_carusel_image.jpg" /></div>
            </Carousel>

            <div className="bulk blue">
                <div className="contained left white-txt">
                    <img alt="example" src="https://54.226.199.227:8000/media/intro/leafagochi.png" />
                </div>
            ...
            <div className="bulk white">
                ...
                <div className="contained right">
                    <img alt="example" src="https://54.226.199.227:8000/media/intro/cutie_patutie.png" />
                </div>
            </div>

            <div className="bulk blue">
                <div className="contained left white-txt">
                    <img alt="example" src="https://54.226.199.227:8000/media/intro/cool.png" />
                </div>
