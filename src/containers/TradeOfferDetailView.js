...
class TradeOfferDetail extends React.Component {
    ...
    acceptTrade = (e) => {
        ...
        axios.put(`https://54.226.199.227:8000/api/trades/${id}/conclude/`, {
    ...
    removeTrade = () => {
        const id = this.state.trade.id;
        axios.delete(`https://54.226.199.227:8000/api/trades/${id}/close`)
        .then((res) => {
    ...
    componentDidMount() {
        ...
        axios.all([
            axios.get(`https://54.226.199.227:8000/api/trades/${id}`),
            axios.get(`https://54.226.199.227:8000/api/users/${user}/javagochis/`)
        ])
        .then(axios.spread((resTrade, resJc) => {
            ...
            axios.get(`https://54.226.199.227:8000/api/javagochi/expmap/${lvl}/`)
            .then(res => {
                this.setState({
                    next_level: res.data
                })
